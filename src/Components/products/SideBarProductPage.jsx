...
export default function SideBarProductPage(props){
    ...
    return(
    <div className="w3-sidebar w3-bar-block" style={{ backgroundColor: "#EC4848", padding: "15px", borderRadius: "10px", color: "white" }} >
        <h1>Products</h1>
        {props.handleCallback({price, inStock})}
                ...
                <Accordion.Body>
                    <Form>
                        <Form.Check
                            ...
                            value={inStock}
                            onClick={(v) => setInStock(inStock ? false : true)}
                        />
                    </Form>
                </Accordion.Body>
        </Accordion.Item>
